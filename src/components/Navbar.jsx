            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-20 items-center">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        <Link to="/" className={`text-sm font-medium transition-colors duration-200 ${isActive('/')} dark:text-gray-200`}>
                            Home <span className="text-xs ml-1">▼</span>
                        </Link>
                        <Link to="/services" className={`text-sm font-medium transition-colors duration-200 ${isActive('/services')} dark:text-gray-200`}>
                            Services <span className="text-xs ml-1">▼</span>
                        </Link>
                        <Link to="/" className="text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-primary-600 transition-colors duration-200">
                            About Us <span className="text-xs ml-1">▼</span>
                        </Link>
                        <Link to="/bookings" className={`text-sm font-medium transition-colors duration-200 ${isActive('/bookings')} dark:text-gray-200`}>
