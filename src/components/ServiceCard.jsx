...
const ServiceCard = ({ service }) => {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 dark:border-gray-700 flex flex-col group">
            <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute top-3 left-3 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm px-2 py-1 rounded-md text-xs font-semibold text-gray-700 dark:text-gray-300 shadow-sm">
                    {service.subCategory}
                </div>
            </div>
            ...
            <div className="p-5 flex-1 flex flex-col">
                <div className="flex justify-between items-start mb-2">
                    <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">{service.name}</h3>
                    <div className="flex items-center bg-yellow-50 dark:bg-yellow-900/30 px-2 py-1 rounded text-yellow-700 dark:text-yellow-500 text-xs font-bold">
                ...
                <div className="flex items-center text-gray-500 dark:text-gray-400 mb-4 text-xs">
                ...
                <div className="mt-auto pt-4 border-t border-gray-50 dark:border-gray-700 flex items-center justify-between">
                    ...
                    <Link
                        ...
                        className="bg-primary-50 dark:bg-gray-700 text-primary-700 dark:text-primary-400 hover:bg-primary-600 dark:hover:bg-primary-600 hover:text-white dark:hover:text-white font-medium py-2 px-4 rounded-lg text-sm transition-all duration-300"
                    >
                        Book Now
                    </Link>
                </div>
