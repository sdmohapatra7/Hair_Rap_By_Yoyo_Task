    ...
    return (
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden flex flex-col group">
            <div className="h-48 overflow-hidden relative">
                ...
                />
                <button className="absolute top-3 right-3 bg-white/80 hover:bg-white p-1.5 rounded-full text-gray-400 hover:text-red-500 transition-colors backdrop-blur-sm">
