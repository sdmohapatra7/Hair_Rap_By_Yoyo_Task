                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="w-full lg:w-64 flex-shrink-0">
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                            <nav className="flex flex-col text-sm text-gray-600">
                                <Link to="#" className="px-6 py-4 hover:bg-gray-50 flex items-center gap-3">
                                ...
                                <Link to="#" className="px-6 py-4 bg-rose-50 text-rose-600 border-l-4 border-rose-500 flex items-center gap-3 font-medium">
                                ...
                                <Link to="#" className="px-6 py-4 hover:bg-gray-50 flex items-center gap-3 text-red-500">
                    ...
                    <div className="flex-1 bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                        ...
                        <div className="flex justify-center mt-8 gap-2">
                            <button className="w-8 h-8 rounded-full bg-rose-500 text-white flex items-center justify-center text-sm font-medium">1</button>
                            <button className="w-8 h-8 rounded-full bg-white text-gray-600 hover:bg-gray-100 flex items-center justify-center text-sm font-medium">2</button>
                            <button className="w-8 h-8 rounded-full bg-white text-gray-600 hover:bg-gray-100 flex items-center justify-center text-sm font-medium">3</button>
                        </div>
                    </div>
                </div>
            </div>
